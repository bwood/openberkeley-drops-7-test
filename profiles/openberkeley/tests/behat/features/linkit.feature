Feature: Link to page on the site
  ...
  Scenario: Add a link to an internal page
    ...
    When I click "Attributes" in the "Linkit Modal" region
      ...
      And I press "Save"
    Then I should see "Linkit Target" in the "a" element with the "title" attribute set to "Testing title" in the "Boxton Content" region
  ...
  Scenario: Add a link to an external page
    When I click the "Linkit" button in the "edit-body-und-0-value" WYSIWYG editor
      ...
      And I press "Insert link"
      And I press "Save"
    Then I should see "https://drupal.org/project/panopoly" in the "a" element with the "title" attribute set to "Testing title" in the "Boxton Content" region
